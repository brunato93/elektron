...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
  ...
  .state('app.slider2', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/layouts/slider2.html"
      }
    }
  })
  .state('app.slider3', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/layouts/slider3.html"
      }
    }
  })
  .state('app.slider4', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/layouts/slider4.html"
      }
    }
  })
  ...
  .state('app.dch', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/layouts/dch.html"
      }
    }
  })
  .state('app.cart', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/layouts/cart.html"
      }
    }
  })
  .state('app.cor', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/layouts/cor.html"
      }
    }
  })
  .state('app.info', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/layouts/info.html"
      }
    }
  })
  .state('app.news', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/layouts/news.html"
      }
    }
  })
  .state('app.cec', {
    ...
    views: {
      'menuContent': {
        templateUrl: "views/app/layouts/cec.html"
      }
    }
  })
